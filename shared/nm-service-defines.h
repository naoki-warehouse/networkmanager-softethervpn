...
#define NM_VPN_SERVICE_TYPE_SOFTETHERVPN "org.freedesktop.NetworkManager.softethervpn"

#define NM_DBUS_SERVICE_SOFTETHERVPN    "org.freedesktop.NetworkManager.softethervpn"
#define NM_DBUS_INTERFACE_SOFTETHERVPN  "org.freedesktop.NetworkManager.softethervpn"
#define NM_DBUS_PATH_SOFTETHERVPN       "/org/freedesktop/NetworkManager/softethervpn"

#define NM_SV_KEY_ENDPOINT      "server-endpoint"
#define NM_SV_KEY_PORT          "server-port"
#define NM_SV_KEY_HUB           "server-hub"
#define NM_SV_KEY_ADDR_IP4      "local-ip4"
#define NM_SV_KEY_ADDR_IP6      "local-ip6"
#define NM_SV_KEY_LISTEN_PORT   "local-listen-port"
#define NM_SV_KEY_PRIVATE_KEY   "local-private-key"
#define NM_SV_KEY_USERNAME      "connection-user"
#define NM_SV_KEY_PASSWORD      "connection-password"
#define NM_SV_KEY_DNS           "connection-dns"
#define NM_SV_KEY_MTU           "connection-mtu"
